...
export const showcaseVariants = {
  ...
  card: cva(
    "relative aspect-[4/5] rounded-3xl bg-[#121417] border border-white/10 p-7 sm:p-8 flex flex-col justify-between transition-all duration-300 hover:border-white/20 hover:scale-[1.01] shadow-xl shadow-black/50"
  ),
};
